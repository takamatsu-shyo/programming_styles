...
class DataStroagemanager():
    ...
    def dispatch(self, message):
        if message[0] == 'init':
            ...
            raise Exception("Message not understood / DataStroagemanager " + message[0])
...
class StopWordManager():
    ...
    def dispatch(self, message):
        if message[0] == 'init':
            ...
            raise Exception("Message not understood / StopWordManager " + message[0])
...
class WordFrequencyManager():
    ...
    def dispatch(self, message):
        if message[0] == 'increment_count':
            ...
            raise Exception("Message not understood / WordFrequencyManager " + message[0])
...
class WordFrequencyController():
    ...
    def dispatch(self, message):
        if message[0] == 'init':
            ...
            raise Exception("Message not understood / WordFrequencyController " + message[0])

    def _init(self, path_to_file):
        self._storage_manager = DataStroagemanager()
